var site_configs = [
    ...
    { // Google Voice
        ...
        "poll": {
            "frequency": 30000,
            "method": "titleMatch",
            "regex": "Google Voice - Inbox \\(([0-9]+)\\)"
        },
        "icon": [
            ['', '#fbfcff', '#ccdbe2', '#205fa6', '#044ca1', '#86acd1', '#fdfffc', '#f9f1ef', '#c33f3a', '#d50100', '#fa0202', '#fd0000', '#fd0002', '#f60100', '#ee0000', ''],
            ['#fcfbff', '#feffff', '#5083b8', '#0057b9', '#0263cc', '#0e62bc', '#dce6f2', '#fffefc', '#f6d4d5', '#e70c0a', '#fd0000', '#fe0103', '#fd0100', '#f60100', '#ec0004', '#e00200'],
            ['#ffffff', '#fbfbfb', '#246cb6', '#0063c8', '#0066cf', '#0059c1', '#83afd2', '#fffeff', '#fefcff', '#e04646', '#f90001', '#fc0300', '#f90101', '#f00003', '#eb0100', '#df0000'],
            ['#fefdff', '#fffcff', '#3b7cbe', '#025dc6', '#0266c8', '#025ac4', '#578ece', '#fffffb', '#ffffff', '#dd5350', '#f40004', '#ff0100', '#fd0003', '#f30100', '#e50000', '#da0203'],
            ['#fffffd', '#fffffd', '#82a9d2', '#0053b9', '#0464ca', '#0258bd', '#5990c8', '#fdfffe', '#fff8ff', '#c72928', '#c21906', '#b12611', '#b62011', '#cc1005', '#e10200', '#d50100'],
            ['#dbe1ed', '#feffff', '#e8f1f6', '#286cb5', '#0054bb', '#0e5db9', '#b9cfe4', '#feffff', '#99b19b', '#1d7020', '#009537', '#03963d', '#00933b', '#098936', '#3a652d', '#8a2b0f'],
            ['#275e9f', '#acbed6', '#fffdfe', '#eff2f9', '#a0bfde', '#dae2ed', '#fdfffe', '#85b899', '#00822c', '#039a3b', '#03983a', '#009637', '#009639', '#01913a', '#00933f', '#018742'],
            ['#1556a8', '#104f9c', '#426fa6', '#84a2be', '#fffefc', '#fffffb', '#bfdac9', '#02771f', '#009b35', '#009937', '#009a37', '#01943c', '#01943c', '#008f38', '#018b3d', '#01873e'],
            ['#2759a2', '#1c55a4', '#084a9e', '#114898', '#dfe8f1', '#fefefe', '#e1ece4', '#269a51', '#00942d', '#029739', '#02973b', '#009438', '#02923b', '#018f3d', '#028b3d', '#008938'],
            ['#22498e', '#385e9d', '#567eb2', '#6e90c0', '#cfdaee', '#fdfffe', '#fefffd', '#ebf2eb', '#46a86b', '#018d2d', '#00963c', '#00933b', '#00933b', '#008f3d', '#008a3d', '#00843d'],
            ['#a6bbd0', '#ebeefd', '#feffff', '#faf0d5', '#e8ddb0', '#decf96', '#f7f3ea', '#ffffff', '#fafcfb', '#49a66d', '#018d2a', '#009338', '#00903b', '#028b39', '#00883c', '#00853c'],
            ['#fffdff', '#f3e9d0', '#ceb038', '#dfb00a', '#e3b500', '#e2ae02', '#d6a92a', '#f1ecd9', '#fffefc', '#d7e8e0', '#0d863f', '#009039', '#038c3c', '#02893d', '#00853e', '#00813e'],
            ['#f8fbf4', '#cca637', '#efb400', '#fec502', '#fbc30a', '#f6be09', '#eaaa00', '#dbb04a', '#fefefe', '#fefcff', '#259155', '#008934', '#008d3b', '#00863d', '#058143', '#017d3e'],
            ['#f2ecde', '#d8a21b', '#f7b910', '#f1b90c', '#f2b50f', '#f0b20f', '#f4b31b', '#e7ab2f', '#fff9f3', '#f6fbfe', '#1d854a', '#008639', '#028541', '#00863c', '#028040', '#007b3d'],
            ['#fbfcfe', '#dfb75f', '#eca70c', '#f0b116', '#f1b215', '#f4b31b', '#f1aa1e', '#eec47c', '#feffff', '#a9cab7', '#037631', '#01833b', '#03823f', '#007d3e', '#007a3e', '#007943'],
            ['', '#fbf4ec', '#ebc57c', '#efb64f', '#f1b145', '#efb64d', '#f6ce93', '#f9fbf6', '#d1e1de', '#1c7849', '#007a34', '#027c3f', '#007c40', '#007b3c', '#007a41', '']
        ]
    },
